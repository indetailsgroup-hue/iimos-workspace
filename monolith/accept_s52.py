...
Same pattern as accept_s51.py — strips all <w:ins> tags, keeps content
...
BAK = '/home/sandbox/monolith_project_summary_v25_accepted_pre_accept_s52_backup.docx'
...
# Verify S52 content survived
s52_ok = (
    'V-CHK-12' in xml and
    'AIE-005' in xml and
    'Section 52' in xml and
    '90-Day Hypercare' in xml and
    'MONOLITH-S52-ONB-001' in xml
)
print(f'S52 content intact: {s52_ok}')

# Verify S51 content also survived
s51_ok = (
