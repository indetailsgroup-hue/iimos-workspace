...
SELECT is(
  (SELECT COUNT(*)::bigint FROM upd_t13),
  0::bigint,
...
SELECT is(
  (SELECT COUNT(*)::bigint FROM upd_t14),
  0::bigint,
...
SELECT is(
  (SELECT COUNT(*)::bigint FROM del_t23),
  0::bigint,
...
SELECT is(
  (SELECT COUNT(*)::bigint FROM del_t24),
  0::bigint,
...
SELECT is(
  (SELECT COUNT(*)::bigint FROM del_t25),
  0::bigint,
