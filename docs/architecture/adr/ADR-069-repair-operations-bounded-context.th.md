...
**การกระทำถัดไปที่อนุญาต:** เจ้าของตรวจฉบับเขียน ADR นี้

**การกระทำถัดไปที่ห้าม:** วางแผนหรือเขียน Phase B จนกว่าเจ้าของอนุมัติ ADR ฉบับเขียนและให้อำนาจวางแผนแยกต่างหาก
