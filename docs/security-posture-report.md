...
**Total pgTAP tests authored (forward migrations):** 14 + 35 + 17 + 18 + 13 + 13 + 16 + 20 + 53 + 25 + 49 = **273 tests** (0179 F1: 14, 0179 NNB: 35, 0180: 17, 0181: 18, 0182: 13, 0183: 13, 0176 notification_preferences: 16, 0186 critical_tables: 20, 0187 installation_domain: 53, 0188 factory_domain: 25, 0189 line_oa_domain: 49)

**Grand total pgTAP assertions (pg_prove SQL suites):** 273 (forward) + 12 (rollback) + 25 (cross-tenant) = **310 tests**
...
*Last updated: 2026-09-01 — pgTAP SQL total 310 (forward 273 + rollback 12 + cross-tenant 25); 0189_line_oa_domain_rls.sql added — Phase 2 batch 3, 49 pgTAP tests (T-0189-01–T-0189-49) covering has_column + col_not_null + relrowsecurity on 11 LINE OA tables, tenant_isolation policy existence, cross-tenant SELECT isolation on line_oa_conversations / line_groups / line_bind_codes, own-org access on line_groups; 0188_factory_domain_rls.sql added — Phase 2 batch 2, 25 pgTAP tests (T-0188-01–T-0188-25) covering has_column + col_not_null + relrowsecurity on 5 factory tables, tenant_isolation policy existence, cross-tenant SELECT isolation on factory_jobs / factory_checkins / factory_job_events, own-org access on factory_jobs; 42 tables remaining in Phase 2 RLS epic (0190–0194); previous session: pgTAP SQL total 236 (forward 199 + rollback 12 + cross-tenant 25); 0187_installation_domain_rls.sql added — Phase 2 batch 1, 53 pgTAP tests (T-0187-01–T-0187-53) covering 12 installation/production tables; 0186_critical_tables_rls.sql added — 20 pgTAP tests covering 4 CRITICAL tables; lint-rls-org-id.py ALLOWLIST 8 → 30 (commit `f159edb994`).*
