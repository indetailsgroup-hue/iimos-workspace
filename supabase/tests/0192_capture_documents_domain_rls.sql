...
VALUES
  ('a1a1a1a1-0192-0000-0000-000000000010'::uuid, 'a1a1a1a1-0000-0000-0000-000000000001'::uuid, 'id_card', 'pending', 'mobile', 'staff-a', 'SITE-0192-A', 'idem-0192-a'),
  ('b2b2b2b2-0192-0000-0000-000000000010'::uuid, 'b2b2b2b2-0000-0000-0001-000000000002'::uuid, 'id_card', 'pending', 'mobile', 'staff-b', 'SITE-0192-B', 'idem-0192-b')
ON CONFLICT DO NOTHING;
